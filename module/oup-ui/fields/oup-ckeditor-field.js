         ...
         */
        {
            ...
            setup: function () {
                ...
                if (this.options.ckeditor && this.toolbarOptions[this.options.ckeditor]) {
                    ...
                    if(type && (type == 'config1' || type == 'config2' || type == 'config3' || type == 'config4' || type == 'config5' || type == 'config6' || type == 'config7' || type == 'config8' || type == 'config11')) {
                        this.options.ckeditor.enterMode = window.CKEDITOR.ENTER_P;
                    }
